  ...
  "suggestedDestination": [
    {
      ...
      "isCrowded": true,
      "crowded": "description of crowd level: Low, Medium, or High",
      "activities": [{activityName : "string" , "description" : "string"}]
    }
  ]
}
...
- "activities" must be an array of objects with "activityName" and "description" fields.
  ...
  "suggestedDestination": [
    {
      ...
      "isCrowded": true,
      "crowded": "It's usually crowded during peak tourist seasons",
      "activities": [{"activityName": "Trekking", "description": "Explore the scenic trails and enjoy the natural beauty."}, {"activityName": "Skiing", "description": "Engage in winter sports and enjoy the snow."}, {"activityName": "Local Culture Exploration", "description": "Visit local markets, temples, and interact with the local community."}]
    }
  ]
}
{
    ...
    "suggestedDestination": [
        {
            ...
            "isCrowded": true,
            "crowded": "It's usually crowded during peak trekking seasons",
            "activities": [{"activityName": "Trekking", "description": "Enjoy the moderate trek to Triund Hill with beautiful landscapes."} , {"activityName": "Camping", "description": "Set up camp at designated spots and enjoy the serene environment."} ,{"activityName":"McLeod Ganj", "description": "Visit the nearby town known for its Tibetan culture and monasteries."}]
        },
        {
            ...
            "isCrowded": false,
            "crowded": "It's usually less crowded except during peak flowering season",
            "activities": [{"activityName": "Trekking", "description": "Explore the scenic trails and enjoy the natural beauty of the valley."}, {"activityName": "Photography", "description": "Capture the vibrant flowers and picturesque landscapes."}]
        }
    ]
}
{
    ...
    "suggestedDestination": [
        {
            ...
            "isCrowded": true,
            "crowded": "It's usually crowded during peak surfing seasons",
            "activities": [{"activityName": "Surfing", "description": "Ride the famous waves at the Banzai Pipeline."} , {"activityName": "Beachcombing", "description": "Explore the beautiful beaches and enjoy the coastal environment."} ,{"activityName":"Snorkeling", "description": "Discover the underwater world and marine life near the shore."}]
        }
    ]
}
`;
